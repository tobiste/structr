---
title: "Strain and Vorticity Analysis"
...
vignette: >
  %\VignetteIndexEntry{Strain and Vorticity Analysis}
...
Import some \eqn{R_f/\phi}{Rf/&phi;} data from elliptical strain markers
...
[^1]: Shimamoto, T., & Ikeda, Y. (1976). A simple algebraic method for
    ...
    [https://doi.org/10.1016/0040-1951(76)90107-4](https://doi.org/10.1016/0040-1951(76)90107-4){.uri}
...
densities in \eqn{R_f/\phi}{Rf/&phi;} space[^2] and plot them in a **\eqn{R_f/\phi}{Rf/&phi;}** diagram[^3]:
...
[^4]: Elliott, D. (1970). Determination of Finite Strain and Initial
    ...
    doi:10.1130/0016-7606(1970)81[2221:DOFSAI]2.0.CO;2
...
$X \geq Y \geq Z$. They can be represented in the **Flinn diagram**[^5],
