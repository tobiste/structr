...
lines(planes, col = "lightgrey", lty = 1, d = 90)
points(planes, col = "#000004", pch = 1, cex = .5)
```
...
lines(lines_mean, d = lines_confangle, col = "#E65164FF")
lines(lines_mean, d = lines_delta, col = "#FB8861FF")
...
lines(planes_eigen$vectors, d = 90, col = viridis::magma(3), lty = 1)
...
lines(planes_eigen$vectors[3, ], d = 90, col = "black", pch = 16)
title(
  main = "Planes",
  sub = paste0(
