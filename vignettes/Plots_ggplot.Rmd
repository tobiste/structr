---
title: "Orientation Plots with ggplot"
author: "Tobias Stephan"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
description: >
  This tutorial introduces the various ways to plot spherical data using ggplots
vignette: >
  %\VignetteIndexEntry{Orientation Plots with ggplot}
...
This tutorial shows how to create orientation plots using ggplot2 in R with the help of the `{structr}` package.
