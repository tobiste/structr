...
The Dip-Pitch-Plunge diagram is a ternary fabric orientation diagram after Balé and Brun (1989)[^1] showing the pitch and plunge of stretching lineation (X) and the dip of the foliation plane (XY). This can be used to asses lateral flow or transpression geometries of Pair objects.

[^1]: Balé, P., & Brun, J.-P. (1989). Late Precambrian thrust and wrench zones in 
