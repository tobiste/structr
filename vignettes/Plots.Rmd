...
### Hsu plot
`hsu_fabric_plot()` creates a Lode parameter[^lode] vs. natural octahedral strain[^nadai] diagram showing the shape of the orientation distribution (after Hsu, 1965).
...
# Fabric strength
fabric_p <- shape_params(planes)$Vollmer["D"]
fabric_l <- shape_params(lines)$Vollmer["D"]
```
