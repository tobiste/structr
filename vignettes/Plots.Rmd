...
**Pair** objects contain plane and line measurements, such as stretching lineations on foliation planes, or intersection lineation of bedding planes etc.
...
The Dip-Pitch-Plunge diagram is a ternary fabric orientation diagram after Balé and Brun (1989)[^8] showing the pitch and plunge of stretching lineation (X) and the dip of the foliation plane (XY). This can be used to asses lateral flow or transpression geometries of Pair objects.
